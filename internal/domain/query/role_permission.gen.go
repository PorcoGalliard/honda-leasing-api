...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.RolePermissionID = field.NewInt64(tableName, "role_permission_id")
...
func (r *rolePermission) updateTableName(table string) *rolePermission {
	...
	r.RolePermissionID = field.NewInt64(table, "role_permission_id")
...
func (r *rolePermission) fillFieldMap() {
	...
	r.fieldMap["role_permission_id"] = r.RolePermissionID
