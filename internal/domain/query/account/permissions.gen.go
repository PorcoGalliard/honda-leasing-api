...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.PermissionType = field.NewString(tableName, "permission_type")
...
func (p *permission) updateTableName(table string) *permission {
	...
	p.PermissionType = field.NewString(table, "permission_type")
...
func (p *permission) fillFieldMap() {
	...
	p.fieldMap["permission_type"] = p.PermissionType
