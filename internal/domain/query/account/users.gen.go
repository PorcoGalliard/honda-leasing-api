...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.PinKey = field.NewString(tableName, "pin_key")
	_user.IsActive = field.NewBool(tableName, "is_active")
	_user.LastLogin = field.NewTime(tableName, "last_login")
	_user.FailedAttempts = field.NewInt16(tableName, "failed_attempts")
...
func (u *user) updateTableName(table string) *user {
	...
	u.PinKey = field.NewString(table, "pin_key")
	u.IsActive = field.NewBool(table, "is_active")
	u.LastLogin = field.NewTime(table, "last_login")
	u.FailedAttempts = field.NewInt16(table, "failed_attempts")
